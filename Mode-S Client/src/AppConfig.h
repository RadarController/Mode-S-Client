...
struct AppConfig
{
    ...
    std::string twitch_client_id;     // deprecated: app credentials are embedded in the build
    std::string twitch_client_secret; // deprecated: app credentials are embedded in the build
